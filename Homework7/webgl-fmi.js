...
Cube = function (center, size, scale, color) {
...
Cube.prototype.draw = function () {
    ...
    scale([this.size * this.scale[0], 
        this.size * this.scale[1], 
        this.size * this.scale[2]]); // и размера
    useMatrix();
...
Cylinder = function (center, size, height, color, xRotation = 0) {
    this.center = center;
    this.size = size;
    this.height = height;
...
var SPHERE_SIDES = 32;
Sphere = function (center, size, color=[0.4, 0.4, 0.4]) {
    this.center = center;
    this.size = size;
    this.n = SPHERE_SIDES;
    this.color = color;
...
Sphere.prototype.updatePosition = function(center) {
    this.center = center;
}
